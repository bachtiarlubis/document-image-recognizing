function varargout = detectToba(varargin)
% DETECTTOBA MATLAB code for detectToba.fig
%      DETECTTOBA, by itself, creates a new DETECTTOBA or raises the existing
%      singleton*.
%
%      H = DETECTTOBA returns the handle to a new DETECTTOBA or the handle to
%      the existing singleton*.
%
%      DETECTTOBA('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in DETECTTOBA.M with the given input arguments.
%
%      DETECTTOBA('Property','Value',...) creates a new DETECTTOBA or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before detectToba_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to detectToba_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help detectToba

% Last Modified by GUIDE v2.5 04-Feb-2019 22:10:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @detectToba_OpeningFcn, ...
                   'gui_OutputFcn',  @detectToba_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before detectToba is made visible.
function detectToba_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to detectToba (see VARARGIN)

% Choose default command line output for detectToba
...
% UIWAIT makes detectToba wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = detectToba_OutputFcn(hObject, eventdata, handles) 
...
[FileName,PathName]=uigetfile('D:\pcd\tester\TemplateMatching\Input dokumen batak\dokumen toba\*.jpg',' Choose a Toba Script Document Image');
fullFileName = fullfile(PathName,FileName);
baseFileName = 'dok_toba1.jpg';
%
...
% --- Executes on button press in btnChangeType5.
function btnChangeType5_Callback(hObject, eventdata, handles)
% hObject    handle to btnChangeType5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in btnClose5.
function btnClose5_Callback(hObject, eventdata, handles)
% hObject    handle to btnClose5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
opts.Interpreter = 'tex';
opts.Default = 'No';
